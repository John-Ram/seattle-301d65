...
function displayPics(){
  ...
  // PUT YOUR RESPONSE IN THIS COMMENT: When var was changed to const, the function was now locally scoped and not accessible globally. as a result the function is void and cannot be called. to fix this rando must be declared globally in order to function.
  console.log(viewed);
